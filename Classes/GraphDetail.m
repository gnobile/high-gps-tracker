...
static GraphDetail *shAcc = nil;

+ (GraphDetail *) shared {
    if (!shAcc) {
        shAcc = [[GraphDetail alloc] init];
    }
    return shAcc;
}
...
- (NSArray *)graphViewXValues:(S7GraphView *)graphView {
	...
	NSString *temp = [documentsDirectory stringByAppendingPathComponent:@"PushAlt"];
    fullPathToFile = [temp stringByAppendingPathComponent:titolo];    
